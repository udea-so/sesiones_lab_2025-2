...
6. **Paso de Argumentos por Valor y por Referencia** ([ejemplo6.c](ejemplo6.c)): Este ejemplo es crucial para entender cómo las funciones manejan sus argumentos.
